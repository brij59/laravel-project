@extends('user/layouts/contentLayoutMaster')
                ...
                <div class="card card-browser-states">
                    ...
                    <div class="card-body">
                        <div class="browser-states">
                            <div class="media">
                                <img src="{{ asset('images/icons/google-chrome.png') }}" class="rounded mr-1"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="{{ asset('images/icons/mozila-firefox.png') }}" class="rounded mr-1"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="{{ asset('images/icons/apple-safari.png') }}" class="rounded mr-1"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="{{ asset('images/icons/internet-explorer.png') }}" class="rounded mr-1"
                        ...
                        <div class="browser-states">
                            <div class="media">
                                <img src="{{ asset('images/icons/opera.png') }}" class="rounded mr-1" height="30"
                                    alt="Opera Mini" />
